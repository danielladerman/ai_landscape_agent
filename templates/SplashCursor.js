// NOTE: This is a React component and requires React/ReactDOM to be loaded.
// It has been adapted from its original module format to work in a non-module <script> tag.
...
function SplashCursor({
  ...
  React.useEffect(() => {
    ...
    const handleMouseMove = (e) => {
        pointers[0].color = pointers[0].color || generateColor();
        updatePointerMoveData(pointers[0], scaleByPixelRatio(e.clientX), scaleByPixelRatio(e.clientY));
    };
    
    const handleTouchMove = (e) => {
        pointers[0].color = pointers[0].color || generateColor();
        updatePointerMoveData(pointers[0], scaleByPixelRatio(e.touches[0].clientX), scaleByPixelRatio(e.touches[0].clientY));
    };
